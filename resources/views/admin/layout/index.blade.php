...
<head>
    ...
    <!-- Font-icon css-->
    <link rel="stylesheet" href="admin_asset/vendors/fontawesome-free-5.1.0-web/css/all.css">
...
<script type="text/javascript" src="admin_asset/js/plugins/chart.js"></script>
